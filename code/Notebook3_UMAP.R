...
suppressPackageStartupMessages({ 
  ...
  source("Data/bin/cell_cycle.R")
  cc.genes <- readRDS("Data/bin/cc.genes.mouse.RDS")
...
spatial_cds = readRDS("Data/E14_slides/RDS_intermediates/Notebook1_E14_spatial_CDS.RDS")


# Incorporate scrublet scores ---------------------------------------------
scrublet_score = 
  read.table(file = "Data/E14_slides/RDS_intermediates/scrublet_doublet_scores.txt",
             header = F)[,1]
...
ggplot(colData(spatial_cds) %>%
  ...
  ggsave("Data/E14_slides/Auxillary_Figures/Notebook2_scrublet_scores.pdf",
         height = 2,
         width = 2)
...
plot_pc_variance_explained(cds = spatial_cds) +
  ggsave(filename = "Data/E14_slides/Auxillary_Figures/Notebook3_scree_plot.pdf",
         height = 4,
         width = 4)
...
sub_clustered_partitions =
  lapply(X = partitions(spatial_cds) %>% 
       ...
       FUN = function(p){
         ...
         plot_cells(cds_p) +
           ggsave(filename = 
                    paste0("Data/E14_slides/Auxillary_Figures/",
                         p,
...
saveRDS(object = spatial_cds,
        file = "Data/E14_slides/RDS_intermediates/Notebook3_E14_spatial_CDS.RDS")

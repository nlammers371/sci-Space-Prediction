...
suppressPackageStartupMessages({ 
  ...
  #source("C:/Users/nlamm/projects/sci-Space/bin/chiSq_test_functions.R")
...
barnyard_cds = 
  load.count.matrix(mat.path = "Data/control_experiment/barnyard/UMI.count.matrix",
                    gene.annotation.path = "Data/control_experiment/barnyard/gene.annotations",
                    cell.annotation.path = "Data/control_experiment/barnyard/cell.annotations")

# Read in hashing data that corresponds to slide and oligo concentration used 
hashTable = 
  read.table("Data/control_experiment/barnyard/hashTable.out",
             sep = "\t",
             header = F,
...
rna_umis = 
  read.table("Data/control_experiment/barnyard/UMIs.per.cell.barcode",
...
barnyard_coldata %>%
  ...
  ggsave("Figures/Figure_Components/Supplement_experiment_QC/barnyard_purity.pdf",
         height = 2,
         width = 2.5)
...
ggplot(barnyard_coldata %>%
  ...
  ggsave("Figures/Figure_Components/Supplement_experiment_QC/barnyard.pdf",
         height = 2.75,
         width = 2.75)
